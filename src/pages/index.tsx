  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the future of commuting with Car Sharing Application, your one-stop solution for seamless, convenient, and eco-friendly travel."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the future of commuting with Car Sharing Application, your one-stop solution for seamless, convenient, and eco-friendly travel.`}
            </Text>
            <Box
